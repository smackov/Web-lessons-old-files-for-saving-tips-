...
"""
l1 = ["even",4,"even",7,"even",55,"even",6,"even",10,"odd",3,"even"]
l2 = ["even",4,"even",7,"even",55,"even",6,"even",9,"odd",3,"even"]
l3 = ["even",10,"odd",2,"even"]
...
find_sum = lambda n: sum(x for x in range(1, n + 1) if x % 3 == 0 or x % 5 == 0)
...
print(get_names(["Ryan", "Mark", "John", "Paul"]))
