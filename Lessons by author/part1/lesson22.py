s = {'apple', 'orange', 'apple', 'pear', 'orange', 'banana'}  # Множества
s11 = ('apple', 'orange', 'apple', 'pear', 'orange', 'banana')  # Кортеж
s22 = ['apple', 'orange', 'apple', 'pear', 'orange', 'banana']  # Список
print(s.__sizeof__())
print(s11.__sizeof__())
